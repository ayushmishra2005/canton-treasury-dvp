...
CANTON_FACT {"kind":"exercised","template":"Template","choice":"Gateway_Redeem","cid":"gateway","consuming":true,"updateId":"upd-redeem-a","argument":{"record":{"requestCid":{"cid":"request-a"},"mintedLockCid":{"cid":"minted-a"},"bindingCid":{"cid":"binding-a"}}},"result":{"record":{}}}
